...
class ElementoDistribuicao:
    def __init__(self, simbolo):   
        ...
        Args:
            simbolo (str): Simbolo do elemento químico a ter sua distribuição eletrônica calculada
        """    
    ...
    def marcar(self):
        """
        Marcação do elétron ao redor do núcleo atômico
    ...
    def imprimir(self):
        """
        Desenho atômo e distribuição na tela
    ...
    def _imprimir_distribuicao_eletronica(self):
        """
        Imprimir distribuição eletrônica do átomo
    ...
    def _imprimir_dados(self): 
        """
        Imprimir informações sobre o átomo (massa, número, símbolo, etc.)
    ...
    def _distribuir_eletrons(self):  
        """
        Cálculo da distribuição eletrônia do átomo
